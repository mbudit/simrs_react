...
router.get("/api/dokter/:id", datamasterController.getDokterById);
router.put("/api/dokter/:id", datamasterController.updateDokter);
router.delete("/api/dokter/:id", datamasterController.deleteDokter);
