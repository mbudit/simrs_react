    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-3 mt-5">
                <h3 className="text-2xl font-semibold">Data Tarif Pelayanan Rawat Inap</h3>
            ...
            <SnackbarProvider maxSnack={3} anchorOrigin={{ vertical: 'top', horizontal: 'right' }}>
                <TableTarifIRI handleSelect={handleSelectLayanan} refreshTrigger={refreshTrigger} />
                <ModalTambahPelayananRanap 
                    open={open}
...
export default TarifPelayananRanap;
