...
export default function TableTarifIRI({ handleSelect, refreshTrigger }) {
    ...
    React.useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_URL}/api/getLayananRanap`)
            .then((res) => {
    ...
    const handleDelete = () => {
        axios.delete(`${import.meta.env.VITE_API_URL}/api/deleteLayananRanap/${deleteId}`)
            .then(() => {
