...
export default function ModalEditRanap({ open, handleCloseEdit, form = {}, setForm, setRefreshTrigger }) {
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/api/update_ranap/${form.id}`, formattedData,
                {
                    headers: {
            ...
            >
                <Fade in={open}>
                    <Box sx={style}>
                        ...
                        >
                            <h2>Edit Pendaftaran Rawat Inap</h2>
                        ...
                        <Box p={2}>
                            <form onSubmit={handleSubmit}>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid columns={12} sx={{ display: 'none' }}>
                                        <TextField
                                            label="Status"
                                            name="status"
                                            value={form.status || ''}
