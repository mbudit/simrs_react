...
export default function TableTarifIGD({ handleSelect, refreshTrigger }) {
    ...
    React.useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_URL}/api/getLayananIGD`)
            .then((res) => {
    ...
    const handleDelete = () => {
        axios.delete(`${import.meta.env.VITE_API_URL}/api/deleteLayananIGD/${deleteId}`)
            .then(() => {
