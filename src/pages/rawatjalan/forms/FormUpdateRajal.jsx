...
export default function ModalUpdateRajal({ open, handleCloseEditRajal, form = {}, setForm, setRefreshTrigger }) {
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            ...
            if (form.status === "Rawat Inap") {
                ...
                responsePut = await axios.put(`${import.meta.env.VITE_API_URL}/api/updateStatusRajal/${form.id}`, formattedData, {
                    headers: {
                        'Content-Type': 'application/json',
                    },
                });
            ...
            >
                <Fade in={open}>
                    <Box sx={style}>
                        ...
                        >
                            <h2>Update Pendaftaran Rawat Jalan</h2>
                            <ModalCloseButton onClick={handleCloseEditRajal} />
                        </Box>
                        ...
                        <Box p={2}>
                            <form onSubmit={handleSubmit}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                                    ...
                                    <Box sx={{ ml: 2 }}>
                                        <ButtonClose onClick={handleCloseEditRajal} />
                                    </Box>
                                </Box>
                            </form>
                        </Box>
