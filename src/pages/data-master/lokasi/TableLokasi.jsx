...
const columnsBase = [
    { field: 'kode_lokasi', headerName: 'Kode Lokasi', headerClassName: 'super-app-theme--header', flex: 1 },
    { field: 'nama_lokasi', headerName: 'Nama Lokasi', headerClassName: 'super-app-theme--header', flex: 1 },
    { field: 'kode_bpjs', headerName: 'Kode BPJS', headerClassName: 'super-app-theme--header', flex: 1 },
    { field: 'latitude', headerName: 'Latitude', headerClassName: 'super-app-theme--header', flex: 1 },
    { field: 'longitude', headerName: 'Longitude', headerClassName: 'super-app-theme--header', flex: 1 },
];

const paginationModel = { page: 0, pageSize: 5 };

export default function TableLokasi({ handleSelect, refreshTrigger }) {
    const [rows, setRows] = React.useState([]);
        ...
        React.useEffect(() => {
            axios.get(`${import.meta.env.VITE_API_URL}/api/getLokasi`)
                .then((res) => {
        ...
        const handleDelete = () => {
            axios.delete(`${import.meta.env.VITE_API_URL}/api/deleteLokasi/${deleteId}`)
                .then(() => {
