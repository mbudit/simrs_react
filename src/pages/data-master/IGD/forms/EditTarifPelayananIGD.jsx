...
export default function ModalEditPelayananIGD({ open, handleCloseEdit, form, setForm, setRefreshTrigger }) {
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/api/updateLayananIGD/${form.id}`, formattedData,
                {
                    headers: {
                ...
                <Fade in={open}>
                    <Box sx={style}>
                        <Box
                            ...
                            >
                            <h2 className="text-xl font-bold">Edit Tarif Pelayanan IGD</h2>
