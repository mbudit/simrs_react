...
export default function ModalTambahPelayananRajal({ open, handleClose, form, setForm, setRefreshTrigger }) {
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/tarif_pelayanan_rajal`, formattedData, {
                headers: {
                ...
                <Fade in={open}>
                    <Box sx={style}>
                        <Box
                            ...
                            >
                            <h2 className="text-xl font-bold">Tambah Tarif Pelayanan Rawat Jalan</h2>
